---
name: vocabulary
description: Capture a vocabulary entry or complete the one pending daily review.
version: 0.1.0
...
- SQLite tool results are the source of truth. Never use Hermes memory or conversation history to decide whether an entry exists or a review is pending.
